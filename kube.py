...
os.system("aws eks --region us-east-1 update-kubeconfig --name krysp-eks --role arn:aws:iam::642168441636:role/krysp-staging-CognitoKubernetesLambdaRole-1LQGM9DHQO5MX")
